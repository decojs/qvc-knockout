describe("when applying violations", {
...
},["knockout", "qvc/Validatable", "qvc/Validator"], function(ko, Validatable, Validator){
  ...
  describe("to an validatable with one field", function(){
    ...
    beforeEach(function(){
      ...
      validatable = new Validatable("SomeExecutable",{
        name: observable
      });
      ...
      validatable.applyViolations(violations, "SomeExecutable");
    });
